					...
					<table cellpadding="10" cellspacing="3" width="800" height="150"
						...
						<tr>
							...
							<td><input type="text" size="3" name="stu_tel"
								value="<%=stu_b.getStu_tel().substring(0, 3)%>">- <input
								type="text" size="4" name="num2"
								value="<%=stu_b.getStu_tel().substring(3, 7)%>">- <input
								type="text" size="4" name="num3"
								value="<%=stu_b.getStu_tel().substring(7, 11)%>"></td>
						...
						<tr>
							...
							<td colspan="3"><input type="text" size="50" id="stu_addr"
								name="stu_addr" value="<%=stu_b.getStu_addr()%>"> <input
								type="button" value="우편번호  검색" onClick="execPostCode()">
							</td>
						</tr>
